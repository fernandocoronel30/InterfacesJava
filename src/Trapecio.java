public class Trapecio implements FigurasGeometricas{
	...
	public String toString() {
		return "Trapecio [nombre=" + nombre + ", lado1=" + lado1 + ", lado2=" + lado2 + ", lado3=" + lado3 + ", lado4="
				...
				+ ", getNombre()=" + getNombre() + ", getLado1()=" + getLado1() + ", getLado2()=" + getLado2()
				+ ", getLado3()=" + getLado3() + ", getLado4()=" + getLado4() + ", getBaseMenor()=" + getBaseMenor()
				+ ", getBaseMayor()=" + getBaseMayor() + ", getAltura()=" + getAltura() + ", toString()="
				+ super.toString() + "]";
	}//toString
